...
function App() {
  ...
  // Routes ctaTarget="modal:<key>" from announcements to the right modal.
  // Add a new key here when wiring a new modal-style CTA.
  const openAnnouncementModal = (key: string) => {
